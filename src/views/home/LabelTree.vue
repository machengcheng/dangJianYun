<template>
    <section class="label-tree-section">
        <div class="label-tree-content">
            <el-row>
                ...
                <el-col :span="19" class="pt20">
                    <div class="search-block">
                        <el-button size="mini" @click="labelSearch" class="search-self">自助查询</el-button>
                    </div>
                    <div class="chartGraphBlock">
                        <div id="chartGraph" ref="chartGraph" class="chartGraph"></div>
                    </div>
                    <el-row class="label-type-block">
                        <el-col :span="8" class="p5">
                            <div class="card-item">
                                <div class="card-title">
                                    <span class="title">一级标签</span>
                                    <a href="javascript: void(0);" class="fr opt-link">more</a>
                                </div>
	...
	export default {
		...
		methods: {
            ...
            labelSearch: function () {
                this.$router.push({ path: '/home/worktable/labelSearch' });
            },
            drawChartGraph() {
                console.info('========-1');
                let that = this;
